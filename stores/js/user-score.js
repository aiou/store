...
function MeetingRoom1(meetingroom_data1){
		//DATA
		 ...
		 this.morens=meetingroom_data1.isDefault
	    ...
	    this.li_cap1.className = "shanchu";
	    this.li_cap1.addEventListener("click",this.delete.bind(this),false);
	    ...
	    this.li_cap2.addEventListener("click",this.editor.bind(this),false);
	    this.li_cap3 = document.createElement("span");
	    this.li_cap3.innerHTML = "已为默认";
	    this.li_cap3.className = "moren-true";   
		this.ul_element.appendChild(this.li_name);
		this.ul_element.appendChild(this.li_num);
		this.ul_element.appendChild(this.li_cap);
		this.ul_element.appendChild(this.li_org);
 ...
 MeetingRoom1.prototype.delete = function(){
  ...
  MeetingRoom1.prototype.editor= function(){
   ...
   $(".peopleaddress1").val(this.detail)
...
$(".tjbutton").click(function(){
  ...
  $("#address-true").click(function(){
    	var a=$(".people").val()
		var b=$(".peoplephone").val()
		var c=$(".peopleaddress").val()
		var sheng=$(".prov").val()
	    var shi=$(".city").val()
	    var xian=$(".dist").val()
	    var data={
...
$("#address-cancel1").click(function(){
	$(".editor-address").hide()
	$(".bcgs").hide()
})
$("#address-true1").click(function(){
        var a=$(".people1").val()
		var b=$(".peoplephone1").val()
		var c=$(".peopleaddress1").val()
